...
import { registerBPVLeerdoelenBlock } from './bpv-leerdoelen/index.js';
import { registerBPVCheckinBlock } from './bpv-checkin/index.js';
import { registerBPVProgressBlock } from './bpv-progress/index.js';
...
export function registerDefaultBlocks(registry) {
  ...
  registerBPVProgressBlock(registry);
  registerBPVCheckinBlock(registry);
  registerBPVCountdownBlock(registry);
  registerBPVQuickLogBlock(registry);
  registerBPVHeatmapBlock(registry);
