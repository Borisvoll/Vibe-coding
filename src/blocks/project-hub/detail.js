import { getProjectById, updateProject } from '../../stores/projects.js';
    ...
    <div class="hub-detail" data-project-detail data-project-id="${projectId}">
      <div class="hub-detail__topbar">
        ...
        <div class="hub-detail__topbar-actions">
          <button type="button" class="btn btn-ghost btn-sm" data-edit-title title="Projectnaam bewerken">✏️</button>
        </div>
      </div>
